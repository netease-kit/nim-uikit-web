const LocaleConfig = {
  ...
  openApplyModeText: '开启了入群审核',
  closeApplyModeText: '关闭了入群审核',
  openAgreeModeText: '开启了入群邀请需要同意',
  closeAgreeModeText: '关闭了入群邀请需要同意',
  ...
  createTeamMemberLimitText: '群人数上限',
  ...
  onDismissDiscussionText: '讨论组已被解散',
  ...
  rejectedTeamText: '已拒绝群申请',
  rejectTeamFailedText: '拒绝群申请失败',
  ...
  joinTeamWithVerifyText: '入群申请已发送',
  ...
  teamJoinModeText: '入群邀请需同意',
  teamJoinModeExplainText: '开启后，拉入入群， 需被邀请人同意',
  teamAgreeModeText: '入群审核',
  teamAgreeModeExplainText: '开启后，成员入群时需要群主或管理同意',
  ...
  leaveDiscussionButtonText: '退出讨论组',
