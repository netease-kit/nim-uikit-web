...
export default {
  ...
  messageStoreAntispamTip: "内容可能涉及敏感信息，请调整后发送",
  messageStoreAntispamTipWithType: "内容可能涉及{type}, 请调整后发送",
  ...
  zhText: "中文",
  enText: "English",
  selectConversationText: "请选择一个会话开始聊天",
  ...
  robotNameText: "机器人昵称",
  robotNamePlaceholder: "请输入机器人昵称",
  robotAvatarText: "机器人头像",
  createRobotSuccessText: "创建机器人成功",
  createRobotFailedText: "创建机器人失败",
  editRobotText: "编辑机器人",
  editRobotSuccessText: "编辑机器人成功",
  editRobotFailedText: "编辑机器人失败",
  deleteRobotText: "删除机器人",
  deleteRobotConfirmText: "确定删除该机器人吗？删除后将无法恢复",
  deleteRobotSuccessText: "删除机器人成功",
  deleteRobotFailedText: "删除机器人失败",
  saveRobotSuccessText: "保存机器人成功",
  saveRobotFailedText: "保存机器人失败",
  robotCardText: "机器人名片",
  robotAccountIdText: "账号",
  viewRobotConfigText: "查看配置串",
  refreshRobotTokenText: "刷新Token",
  refreshTokenConfirmText:
    "刷新后，旧Token将立即失效，正在使用的机器人需要重新配置",
  refreshTokenSuccessText: "Token刷新成功",
  refreshTokenFailedText: "Token刷新失败",
  viewConfigFailedText: "查看配置串失败，请检查网络",
  robotConfigText: "机器人配置",
  robotConfigWarningText: "请妥善保管，不要泄露给他人",
  robotTokenText: "Token",
  copyFullConfigText: "复制完整配置串",
  copyConfigText: "复制配置",
  copyTokenText: "复制Token",
  robotEmptyText: "暂无机器人",
  robotEmptyTipText: "点击右上角创建",
  robotLimitReachedText: "机器人已达上限，请选择已有机器人或删除机器人",
  robotNameRequiredText: "机器人昵称不能为空",
  sendMessageToRobotText: "给机器人发消息",
