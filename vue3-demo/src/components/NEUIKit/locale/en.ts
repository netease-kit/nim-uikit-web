...
export default {
  ...
  voiceToTextLoadingText: "Converting speech to text...",
  ...
  forwardMsgHasUnforwardableText:
    "Unforwardable messages have been unselected. Please send again.",
  ...
  aiConversationSelectFailed: "Failed to open AI conversation",
  myAIUserText: "My AI Users",
  noAIUserText: "No AI users yet",
  ...
  messageStoreAntispamTip:
    "The content may contain sensitive information. Please edit it and send again.",
  messageStoreAntispamTipWithType:
    "The content may contain {type}. Please edit it and send again.",
  commonAntispamPornography: "pornography",
  commonAntispamAdvertising: "advertising",
  commonAntispamAdvertisingLaw: "advertising law",
  commonAntispamViolence: "violence",
  commonAntispamProhibited: "prohibited content",
  commonAntispamPolitics: "political content",
  commonAntispamAbuse: "abuse",
  commonAntispamSpam: "spam",
  commonAntispamOther: "other sensitive content",
  commonAntispamValue: "value-related content",
  ...
  zhText: "中文",
  enText: "English",
  selectConversationText: "Please select a conversation to start chatting",
  ...
  // Robot
  myRobotsText: "My Bots",
  createRobotText: "Create Bot",
  robotNameText: "Bot Name",
  robotNamePlaceholder: "Please enter bot name",
  robotAvatarText: "Bot Avatar",
  createRobotSuccessText: "Bot created successfully",
  createRobotFailedText: "Failed to create bot",
  editRobotText: "Edit Bot",
  editRobotSuccessText: "Bot updated successfully",
  editRobotFailedText: "Failed to update bot",
  deleteRobotText: "Delete Bot",
  deleteRobotConfirmText:
    "Are you sure you want to delete this bot? This action cannot be undone.",
  deleteRobotSuccessText: "Bot deleted successfully",
  deleteRobotFailedText: "Failed to delete bot",
  saveRobotSuccessText: "Bot saved successfully",
  saveRobotFailedText: "Failed to save bot",
  robotCardText: "Bot Card",
  robotAccountIdText: "Account",
  viewRobotConfigText: "View Config",
  refreshRobotTokenText: "Refresh Token",
  refreshTokenConfirmText:
    "After refreshing, the old token will expire immediately and any bot currently in use must be reconfigured.",
  refreshTokenSuccessText: "Token refreshed successfully",
  refreshTokenFailedText: "Failed to refresh token",
  viewConfigFailedText: "Failed to view config. Please check your network.",
  robotConfigText: "Bot Config",
  robotConfigWarningText:
    "Please keep it safe and do not share it with others.",
  robotTokenText: "Token",
  copyFullConfigText: "Copy Full Config",
  copyConfigText: "Copy Config",
  copyTokenText: "Copy Token",
  robotEmptyText: "No bots yet",
  robotEmptyTipText: "Click the top right corner to create",
  robotLimitReachedText:
    "Bot limit reached. Please select an existing bot or delete a bot.",
  robotNameRequiredText: "Bot name cannot be empty",
  sendMessageToRobotText: "Send message to bot",
